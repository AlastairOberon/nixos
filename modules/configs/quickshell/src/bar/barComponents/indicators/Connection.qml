...
Item {
    ...
    property bool isActive: typeof myLauncher !== "undefined" && 
                            ...
                            myLauncher.window.currentTabIndex === 10
    ...
    Rectangle {
        anchors.fill: parent
        radius: 12
        color: netRoot.isActive ? Theme.secondary : (netMouseArea.containsMouse ? Theme.urgent : "transparent")
    ...
    RowLayout {
        ...
        Text {
            ...
            color: (netRoot.isActive || netMouseArea.containsMouse) ? Theme.base : (netRoot.isConnectionWarning ? Theme.urgent : Theme.text)
        ...
        ColumnLayout {
            ...
            Text { 
                ...
                color: (netRoot.isActive || netMouseArea.containsMouse) ? Theme.base : (netRoot.isConnectionWarning ? Theme.urgent : Theme.secondary)
                Behavior on color { ColorAnimation { duration: 150 } }
            }
