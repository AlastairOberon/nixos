...
Item {
    ...
    property string currentLocation: "Kakkanad, India"
    property real currentLat: 10.0158
    property real currentLon: 76.3418
    ...
    // --- SOURCE PICKER STATE ---
    property string currentSource: "Open-Meteo"
